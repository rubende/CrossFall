import Redes.Fusion_Loss as Interface
    ...
    with graph.as_default():
        ...
        with tf.device('/gpu:'+str(index_gpu)):
            with sess.as_default():
                ...
                print(X_train[index_data].shape)
                print("y_train_external: " + str(len(y_train[index_data])))
                model = Interface.Red.build((1, 301, 3), (1, 51, 3), 2, number_convolutional_layers=4, first_number_filters=256, dropout=0.5)
...
name_path = "../Results/result_05_fullWindow/fusion_loss_4_capas/escalado/sin_weight/"
