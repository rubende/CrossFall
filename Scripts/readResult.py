...
name_path = "/lstm_fine/escalado/sin_weight_subject/"
#name_path = "/lstm_4_capas/escalado/con_weight_0.67/"
dataset = "result_05"
...
for i in range(number_folds):
    ...
    with open(name_path + name_file + "_all_" + str(i) + '.pkl', 'rb') as f:  # Python 3: open(..., 'rb')
        [score_acc, score_fall, score_adl,
         score_maa, score_sensitivity, score_specificity,
         val_score_acc, val_score_fall,
         val_score_adl, val_score_maa,
         val_score_sensitivity, val_score_specificity, val_f1, val_f1_tf, val_f1_tf2, number_adl, number_fall] = pickle.load(f)
