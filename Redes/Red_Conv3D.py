...
class Red:
    ...
    def build(input_shape, num_classes, number_convolutional_layers, first_number_filters, weight_decay=1e-4,
        ...
        print(model_input)
        output = Conv3D(first_number_filters, kernel_size=(1, filter_size, 1), kernel_regularizer=L2_norm, \
                        activation='relu', input_shape=input_shape)(model_input)
        output = BatchNormalization()(output)
        output = MaxPooling3D(pool_size=(1, 2, 1))(output)
        ...
        output = AveragePooling3D(pool_size=(1, output.shape[2].value, output.shape[3].value))(output)
